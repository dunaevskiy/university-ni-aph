...
class PixiBoot extends PIXI.Application {
	private contGarden: PIXI.Container;
	...
	constructor() {
		...
		this.contGarden = new PIXI.Container();
		...
		garden.position.set(-window.innerWidth / 2, -window.innerHeight / 2);
		this.contGarden.addChild(garden);
		...
		this.stage.addChild(this.contGarden);
